...
unsigned long skb_free[RMNET_STATS_SKBFREE_MAX];
...
unsigned long queue_xmit[RMNET_STATS_QUEUE_XMIT_MAX * 2];
...
unsigned long agg_count[RMNET_STATS_AGG_MAX];
...
unsigned long checksum_dl_stats[RMNET_MAP_CHECKSUM_ENUM_LENGTH];
...
unsigned long checksum_ul_stats[RMNET_MAP_CHECKSUM_ENUM_LENGTH];
