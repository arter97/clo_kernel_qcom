...
#define AQR_MACSEC_MAX_SC 32
#define AQR_MACSEC_MAX_SA 32

enum aqr_macsec_sc_sa {
	aqr_macsec_sa_sc_4sa_8sc,
	aqr_macsec_sa_sc_not_used,
	aqr_macsec_sa_sc_2sa_16sc,
	aqr_macsec_sa_sc_1sa_32sc,
};

struct aqr_macsec_common_stats {
