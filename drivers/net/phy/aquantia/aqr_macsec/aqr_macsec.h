...
#ifndef __AQR_MACSEC_API_H__
#define __AQR_MACSEC_API_H__


/*! This enumeration is used to describe the different types of Aquantia PHY.*/
enum aqr_device
{    
	aqr_gen_2,
	aqr_gen_3, /* AQR109 */
...
struct aqr_mdio_ops
{
	int (*aqr_mdio_write)(void *priv, unsigned int mmd, unsigned int address, unsigned int data);
	int (*aqr_mdio_read)(void *priv, unsigned int mmd, unsigned int address);
};

struct aqr_port
{
	void *priv;
	enum aqr_device device;
	struct aqr_mdio_ops mdio_ops;
};

/* AQR Gen4 only */
enum aqr_macsec_mode
{
	macsec_normal = 0,
	macsec_xpn = 1   
}  ;  

struct aqr_salt_value
{
	uint32_t  word0;
	uint32_t  word1;
	uint32_t  word2;
 ...
 *  table.
 */
struct aqr_mss_egress_ctlf_record {
 ...
 *  Classifier table.
 */
struct aqr_mss_egress_class_record {
	/*! VLAN ID field. */
	uint32_t vlan_id;
	/*! VLAN UP field. */
	uint32_t vlan_up;
...
struct aqr_mss_egress_sc_record {
...
struct aqr_mss_egress_sa_record {
	/*! This is to specify when the SC was first used. Set by HW. */
	uint32_t start_time;
	/*! This is to specify when the SC was last used. Set by HW. */
	uint32_t stop_time;
 ...
 *  Lookup table.
 */
struct aqr_mss_egress_sakey_record {
 ...
 *  CTL Filter table.
 */
struct aqr_mss_ingress_prectlf_record {
 ...
 */
struct aqr_mss_ingress_preclass_record {
...
struct aqr_mss_ingress_sc_record {
	/*! This is to specify when the SC was first used. Set by HW. */
	uint32_t stop_time;
	/*! This is to specify when the SC was first used. Set by HW. */
	uint32_t start_time;
...
struct aqr_mss_ingress_sa_record {
	/*! This is to specify when the SC was first used. Set by HW. */
	uint32_t stop_time;
	/*! This is to specify when the SC was first used. Set by HW. */
	uint32_t start_time;
 ...
 *  Lookup table.
 */
struct aqr_mss_ingress_sakey_record {
	/*! Key for AES-GCM processing. */
	uint32_t key[8];
	/*! AES key size
	 *  00 - 128bits
 ...
 */
struct aqr_mss_ingress_postclass_record {
	/*! The 8 bit value used to compare with extracted value for byte 0. */
	uint32_t byte0;
	/*! The 8 bit value used to compare with extracted value for byte 1. */
	uint32_t byte1;
 ...
 */
struct aqr_mss_ingress_postctlf_record {
	/*! This is used to store the 48 bit value used to compare SA, DA
	 *  or halfDA+half SA value.
	 */
	uint32_t sa_da[2];
 ...
 */
struct aqr_mss_egress_sc_counters {
 ...
 *  64 bits, lower 32 bits in field[0].
 */
struct aqr_mss_egress_sa_counters {
 ...
 *  bits in field[0].
 */
struct aqr_mss_egress_common_counters {
 ...
 *  64 bits, lower 32 bits in field[0].
 */
struct aqr_mss_ingress_sa_counters {
 ...
 *  bits in field[0].
 */
struct aqr_mss_ingress_common_counters {
...
int aqr_mss_get_egress_sa_expired(struct aqr_port *port, u32 *expired);
/*!  Get Egress SA threshold expired. */
int aqr_mss_get_egress_sa_threshold_expired(struct aqr_port *port,
					   u32 *expired);
/*!  Set Egress SA expired. */
int aqr_mss_set_egress_sa_expired(struct aqr_port *port, u32 expired);
/*!  Set Egress SA threshold expired. */
int aqr_mss_set_egress_sa_threshold_expired(struct aqr_port *port,
					   u32 expired);
