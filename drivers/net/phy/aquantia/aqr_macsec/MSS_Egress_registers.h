...
/* AQR gen4 only */
#define MSS_EGRESS_GCM_SALT_REGISTER_ADDR 0x5056
...
struct mss_egress_ctl_register {
	...
	union {
		...
		} bits_1; /* AQR PHY Gen 2-3 */
		struct {
			unsigned int ethertype_explicit_sectag_msb : 13;
			unsigned int gen4_128_bit_key_only : 1;
			unsigned int gen4_extended_packet_numbering : 1;
			unsigned int reserved0 : 1;

		} bits_1_gen4; /* AQR PHY Gen4 */
