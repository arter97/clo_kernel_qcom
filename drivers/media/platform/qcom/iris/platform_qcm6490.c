...
static struct codec_info codec_data_qcm6490[] = {
	{
...
static struct color_format_info color_format_data_qcm6490[] = {
	{
...
static struct plat_core_cap core_data_qcm6490[] = {
...
static struct plat_inst_cap instance_cap_data_qcm6490[] = {
	...
	{QUEUED_RATE, DEC, CODECS_ALL,
		(MINIMUM_FPS << 16), INT_MAX,
		1, (DEFAULT_FPS << 16)},

	{FRAME_RATE, ENC, CODECS_ALL,
		(MINIMUM_FPS << 16), (MAXIMUM_ENCODE_FPS << 16),
		1, (DEFAULT_FPS << 16),
		0,
		HFI_PROP_FRAME_RATE,
...
static const struct bus_info qcm6490_bus_table[] = {
		{ NULL, "iris-cnoc", 1000, 1000    },
		{ NULL, "iris-ddr",  1000, 8000000 },
};

static const struct clock_info qcm6490_clk_table[] = {
		{ NULL, "core",              VIDEO_CC_MVSC_CORE_CLK,     1 },
		{ NULL, "bus",               VIDEO_CC_MVSC_CTL_AXI_CLK,  0 },
		{ NULL, "iface",             VIDEO_CC_VENUS_AHB_CLK,     0 },
		{ NULL, "vcodec_bus",        VIDEO_CC_MVS0_AXI_CLK,      0 },
		{ NULL, "vcodec_core",       VIDEO_CC_MVS0_CORE_CLK,     1 },
};

static const char * const qcm6490_pd_table[] = { "venus", "vcodec0", NULL };

static const char * const qcm6490_opp_pd_table[] = {"cx", NULL };

static const struct bw_info qcm6490_bw_table_enc[] = {
	{  972000,  808000, 1350000 },	/* 3840x2160@30 */
	{  489600,  547000,  732000 },	/* 1920x1080@60 */
	{  244800,  283000,  375000 },	/* 1920x1080@30 */
};

static const struct bw_info qcm6490_bw_table_dec[] = {
	{ 2073600, 2266000, 4317000 },	/* 4096x2160@60 */
	{ 1036800, 1156000, 2181000 },	/* 4096x2160@30 */
	{  489600,  731000,  998000 },	/* 1920x1080@60 */
	{  244800,  376000,  534000 },	/* 1920x1080@30 */
};

static const struct reg_preset_info qcm6490_reg_preset_table[] = {
	{ 0xB0088, 0x0, 0x11 },
};

static struct ubwc_config_data ubwc_config_qcm6490[] = {
	UBWC_CONFIG(8, 32, 15, 0, 1, 1, 1),
};

static struct format_capability format_data_qcm6490 = {
	.codec_info = codec_data_qcm6490,
	.codec_info_size = ARRAY_SIZE(codec_data_qcm6490),
	.color_format_info = color_format_data_qcm6490,
	.color_format_info_size = ARRAY_SIZE(color_format_data_qcm6490),
};

static const u32 qcm6490_vdec_src_change_param_avc[] = {
...
static const u32 qcm6490_vdec_src_change_param_hevc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 qcm6490_vdec_src_change_param_vp9[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 qcm6490_vdec_input_properties[] = {
	HFI_PROP_NO_OUTPUT,
};
...
struct platform_data qcm6490_data = {
	.bus_tbl = qcm6490_bus_table,
	.bus_tbl_size = ARRAY_SIZE(qcm6490_bus_table),
	.clk_tbl = qcm6490_clk_table,
	.clk_tbl_size = ARRAY_SIZE(qcm6490_clk_table),
	.clk_rst_tbl = NULL,
	.clk_rst_tbl_size = 0,

	.bw_tbl_enc = qcm6490_bw_table_enc,
	.bw_tbl_enc_size = ARRAY_SIZE(qcm6490_bw_table_enc),
	.bw_tbl_dec = qcm6490_bw_table_dec,
	.bw_tbl_dec_size = ARRAY_SIZE(qcm6490_bw_table_dec),

	.pd_tbl = qcm6490_pd_table,
	.pd_tbl_size = ARRAY_SIZE(qcm6490_pd_table),
	.opp_pd_tbl = qcm6490_opp_pd_table,
	.opp_pd_tbl_size = ARRAY_SIZE(qcm6490_opp_pd_table),
	...
	.core_data_size = ARRAY_SIZE(core_data_qcm6490),
	.inst_cap_data = instance_cap_data_qcm6490,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_qcm6490),
	.ubwc_config = ubwc_config_qcm6490,
	.format_data = &format_data_qcm6490,

	.avc_subscribe_param =
		qcm6490_vdec_src_change_param_avc,
	.avc_subscribe_param_size =
		ARRAY_SIZE(qcm6490_vdec_src_change_param_avc),
	.hevc_subscribe_param =
		qcm6490_vdec_src_change_param_hevc,
	.hevc_subscribe_param_size =
		ARRAY_SIZE(qcm6490_vdec_src_change_param_hevc),
	.vp9_subscribe_param =
		qcm6490_vdec_src_change_param_vp9,
	.vp9_subscribe_param_size =
		ARRAY_SIZE(qcm6490_vdec_src_change_param_vp9),
	.dec_input_prop = qcm6490_vdec_input_properties,
	.dec_input_prop_size = ARRAY_SIZE(qcm6490_vdec_input_properties),
	.dec_output_prop_avc = qcm6490_vdec_output_properties_avc,
	.dec_output_prop_size_avc = ARRAY_SIZE(qcm6490_vdec_output_properties_avc),
	.dec_output_prop_hevc = qcm6490_vdec_output_properties_hevc,
	.dec_output_prop_size_hevc = ARRAY_SIZE(qcm6490_vdec_output_properties_hevc),
	.dec_output_prop_vp9 = qcm6490_vdec_output_properties_vp9,
	.dec_output_prop_size_vp9 = ARRAY_SIZE(qcm6490_vdec_output_properties_vp9),
};
